                        ...
                        <div className="rounded-lg bg-muted/50 p-3">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            ...
                            >
                              ...
                              {interviewPrepJobIds.has(job.id) && <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />}
                            </Button>
                            ...
                            >
                              ...
                              {smartAnalysisJobIds.has(job.id) && <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />}
                            </Button>
