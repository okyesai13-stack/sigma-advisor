    ...
    try {
      ...
      pdfContent.innerHTML = `
        ...
        <div style="text-align: center; margin-top: 25px; padding-top: 15px; border-top: 2px solid #e5e7eb;">
          ...
          <div style="margin-top: 12px; padding: 10px; background: #f5f3ff; border-radius: 8px; border: 1px solid #e9d5ff;">
            <p style="color: #6d28d9; font-size: 11px; font-weight: bold; margin: 0 0 4px 0;">🔗 View Your Full Dashboard Anytime</p>
            <a href="https://sigma-advisor.lovable.app/dashboard?resumeId=${resumeId}" style="color: #7c3aed; font-size: 10px; word-break: break-all; text-decoration: underline;">sigma-advisor.lovable.app/dashboard?resumeId=${resumeId}</a>
          </div>
        </div>
      `;
...
🔗 sigma-advisor.lovable.app`
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
          ...
          <div className="flex items-center gap-4">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="outline" size="sm">Start Over</Button>
              </AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>Are you sure?</AlertDialogTitle>
                  <AlertDialogDescription>This will clear all your session data including resume, career analysis, and saved results. This action cannot be undone.</AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        {/* Career Goal Score */}
        <CareerGoalScoreCard data={goalScoreData ? {
          goal_score: goalScoreData.goal_score,
          score_breakdown: goalScoreData.score_breakdown,
          recommendations: goalScoreData.recommendations,
          ninety_day_plan: goalScoreData.ninety_day_plan,
          target_role: goalScoreData.target_role,
        } : null} />

        {/* 3. Overall Assessment */}
        <OverallAssessmentCard overallAssessment={overallAssessment} />
        ...
        {/* 9. AI Future Roles */}
        {resumeId && <AIRolesSection resumeId={resumeId} />}
